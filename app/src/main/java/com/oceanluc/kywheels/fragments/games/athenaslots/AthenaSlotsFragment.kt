package com.oceanluc.kywheels.fragments.games.athenaslots
...
class AthenaSlotsFragment : CurrentFragment(true) {
    ...
    private fun getGameItems(seed: Int): List<SlotObj> {
        val slotItems = listOf(
            R.drawable.first_item_second_slots to "K",
            R.drawable.second_item_second_slots to "Q",
            R.drawable.third_item_second_slots to "J",
            R.drawable.fourth_item_second_slots to "A",
            R.drawable.fifth_item_second_slots to "10"
